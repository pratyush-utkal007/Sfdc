...
const ServiceSection = () => {
  return (
    <>
      <section
        className="md:py-20 py-10  md:px-16 sm:px-10 px-6 shadow-2xl bg-slate-200   text-center"
        id="services"
      >
        <h2 className="md:text-4xl text-2xl my-6 font-bold inline-block text-black text-center mb-10 font-Krub">
          Our Services
        </h2>
