...
export default function AgentforcePage() {
  ...
  const resources = [
    ...
    {
      id: 2,
      title: "Agentforce – the third wave of the AI revolution is here!",
        ...
        >
          {[
            ...
            <motion.div
              ...
              transition={{ duration: 0.3 }}
              className="bg-white/5 rounded-2xl shadow-lg overflow-hidden p-6 text-center"
            >
              <img
                src={item.img}
                alt={item.title}
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {[
            ...
            },
            {
              ...
              a: "Businesses implementing Agentforce have achieved:\n\n- 30% faster sales cycles\n- 40% increase in case deflection\n- 45% boost in overall ROI",
            },
            {
