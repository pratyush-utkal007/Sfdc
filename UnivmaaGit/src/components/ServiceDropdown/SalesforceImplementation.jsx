  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black text-white pb-10">
        {/* Hero Section */}
        <motion.section
          className="container mx-auto px-6 md:px-20 pt-40 pb-32 py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-10"
        ...
        >
          ...
          <div className="flex justify-center relative">
            ...
            <div className="absolute bottom-[-40px] flex flex-col items-center z-0">
              <motion.div
                className="w-10 h-24 bg-gradient-to-b from-yellow-300 via-orange-500 to-transparent rounded-full blur-lg"
              ...
              />
              <motion.div
                className="w-3 h-3 bg-yellow-400 rounded-full blur-sm mt-2"
        ...
        >
          ...
          {/* Form */}
          <motion.div
            className="bg-gradient-to-b from-purple-600 to-black p-8 rounded-2xl shadow-lg w-3/4 max-w-md mx-auto mt-12"
            initial={{ opacity: 0, y: 80 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 1 }}
            viewport={{ once: true }}
        ...
        >
          ...
          >
            ...
            >
              <motion.div
                className="w-12 h-24 bg-gradient-to-b from-yellow-300 via-orange-500 to-transparent rounded-full blur-lg"
