      ...
      <div className="relative overflow-hidden">
        ...
        <AnimatePresence>
          {formOpen && (
            ...
            >
              <motion.div
                className="bg-gray-900 text-white rounded-2xl shadow-xl w-[90%] max-w-lg p-8 relative"
        ...
        <AnimatePresence>
          {open && (
            ...
            >
              <motion.div
                key={step}
                className="bg-white rounded-2xl shadow-xl w-full sm:w-[90%] max-w-4xl relative overflow-hidden max-h-[90vh] overflow-y-auto"
                initial={{ y: 50, opacity: 0, scale: 0.95 }}
                animate={{ y: 0, opacity: 1, scale: 1 }}
                exit={{ y: 50, opacity: 0, scale: 0.95 }}
                transition={{ duration: 0.4 }}
