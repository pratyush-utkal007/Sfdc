...
const Aboutus = () => {
  ...
  // explicit per-card animation controllers
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <motion.section
        ...
        className="relative text-white py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-16 text-center bg-cover bg-center bg-no-repeat"
        style={{
      ...
      >
        ...
        <div className="relative z-10 pt-16">
          ...
          <motion.p
            ...
            className="text-base  sm:text-lg md:text-2xl pt-10 max-w-3xl mx-auto leading-relaxed px-2"
          >
      ...
      {/* Mission & Vision */}
      <section className="py-12 sm:py-16 px-4 sm:px-6 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10 bg-black">
        <motion.div
      ...
      {/* Why Choose Univmaa */}
      <section className="bg-black text-white py-16 sm:py-20 px-4 sm:px-6 md:px-16">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">
            Why Choose Univmaa?
          </h2>
          <p className="max-w-3xl  mx-auto md:text-xl text-gray-300 text-lg sm:text-base">
            We deliver excellence and create value for customers and
            communities. Our expert, committed team put our shared values into
            action – every day. With the best talent and the latest technology
            we help customers turn complexity into opportunities and create
            meaningful change.
          </p>
        </div>
      ...
      <section className="bg-black text-white py-12 sm:py-16 px-4 sm:px-6">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="max-w-3xl mx-auto text-gray-300  md:text-xl text-sm sm:text-base">
            We believe innovation is more than just technology — it’s about
            transforming ideas into real business value. By combining
            cutting-edge solutions, seamless integrations, and industry best
            practices, we empower organizations to stay ahead in a rapidly
            changing world.
          </p>
        </div>
        ...
        >
          ...
          <motion.button
            ...
            className="bg-blue-500 hover:bg-blue-700 text-white px-5 sm:px-6 py-3 rounded-lg font-medium shadow-md text-sm sm:text-base"
          >
