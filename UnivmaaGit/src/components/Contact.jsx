...
const Contact = () => {
  ...
  return (
    <div
      className="bg-white px-4 sm:px-8 md:px-12 lg:px-20 py-10 md:py-20"
      id="contact-us"
    >
      <div className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-20">
        ...
        <motion.div
          ...
          className="lg:w-1/2 w-full bg-white shadow-xl rounded-xl p-6 sm:p-8 border border-gray-200"
        >
